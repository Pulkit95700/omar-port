...
const ContactMe = () => {
    return (
        <section className="section-2 h-[100vh] max-md:h-auto px-10  max-md:px-6 py-10 relative w-full">
            <div className="absolute z-20 -top-48 right-20 w-[300px] h-full">
                <Image
            ...
            <h1 className="text-[5.5rem] max-md:text-[4rem] font-nanum text-black font-semibold pl-10 max-md:pl-0">
                Contact Me
            </h1>
            {/* <div className="w-full flex items-center justify-center h-full"> */}
            <form className="form w-[500px] max-md:w-full mx-auto mt-10 ">
                <div className="title">
                    Welcome,
                    <br />
                    <span>Reach me through your</span>
                </div>
                <input
                    type="email"
                    placeholder="Email"
            ...
            <div className="absolute z-20 -bottom-52 w-96 h-full -left-10 max-md:hidden">
                <Image
